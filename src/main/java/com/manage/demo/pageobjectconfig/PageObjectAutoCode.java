...
import com.manage.demo.util.Log;
...
public class PageObjectAutoCode {
	...
	static  String path="src/main/java/com/manage/demo/pageObjectConfig/UILibrary.xml";
	public static void autoCode() throws Exception
	{
		...
		for(Iterator<?> i=root.elementIterator();i.hasNext();)
		{
			...
			System.out.println("pageName111111111111111"+pageName);
			//将pageName存储为数组
			String[] pageNameArray=pageName.split("\\.");
//			System.out.println("pageNameArray2222222222222"+pageNameArray);
//			System.out.println("pageNameArray333333"+pageNameArray[0]);
			//获取要写入的page所属的类名
			...
			sb.append("import com.manage.demo.util.BaseAction;\n");
			sb.append("import com.manage.demo.util.Locator;\n");
			sb.append("import com.manage.demo.pageobjectconfig.PageObjectAutoCode;");
			...
			sb.append("private String path=\"src/main/java/com/manage/demo/pageObjectConfig/UILibrary.xml\";\n");
			...
			for(Iterator<?> j=page.elementIterator();j.hasNext();)
			{
				...
				System.out.println("111111122222222"+locator);
				System.out.println("locator.attributeCount()111"+locator.attributeCount());
			...
			File pageObjectFile=new File("src/main/java/com/manage/demo/pagemanage/"+pageClassName+".java");
